...
umain(int argc, char **argv)
{
  ...
  800049:	ff 35 00 00 10 f0    	pushl  0xf0100000
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800267:	0f be 84 03 71 ef ff 	movsbl -0x108f(%ebx,%eax,1),%eax
  80026e:	ff 
  80026f:	50                   	push   %eax
...
008002bf <vprintfmt>:
{
  ...
  800330:	03 b4 81 00 f0 ff ff 	add    -0x1000(%ecx,%eax,4),%esi
...
008003f4 <.L28>:
  ...
  800417:	8d 80 92 ef ff ff    	lea    -0x106e(%eax),%eax
  80041d:	50                   	push   %eax
  80041e:	57                   	push   %edi
  80041f:	56                   	push   %esi
  ...
  800434:	8d 80 89 ef ff ff    	lea    -0x1077(%eax),%eax
  80043a:	50                   	push   %eax
  80043b:	57                   	push   %edi
  80043c:	56                   	push   %esi
...
0080044d <.L24>:
  ...
  800463:	8d 80 82 ef ff ff    	lea    -0x107e(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c3b:	8d 83 58 f1 ff ff    	lea    -0xea8(%ebx),%eax
  800c41:	50                   	push   %eax
  800c42:	6a 23                	push   $0x23
  800c44:	8d 83 75 f1 ff ff    	lea    -0xe8b(%ebx),%eax
  800c4a:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ca4:	57                   	push   %edi
  800ca5:	50                   	push   %eax
  800ca6:	8d 83 84 f1 ff ff    	lea    -0xe7c(%ebx),%eax
  800cac:	50                   	push   %eax
  ...
  800cb9:	e8 83 f4 ff ff       	call   800141 <vcprintf>
	cprintf("\n");
  800cbe:	8d 83 a7 f1 ff ff    	lea    -0xe59(%ebx),%eax
