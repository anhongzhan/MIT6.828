	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800203:	0f be 80 a8 24 80 00 	movsbl 0x8024a8(%eax),%eax
  80020a:	50                   	push   %eax
...
0080025a <vprintfmt>:
{
  ...
  8002aa:	3e ff 24 85 e0 25 80 	notrack jmp *0x8025e0(,%eax,4)
  8002b1:	00 
  ...
  800377:	8b 14 85 40 27 80 00 	mov    0x802740(,%eax,4),%edx
  80037e:	85 d2                	test   %edx,%edx
  800380:	74 18                	je     80039a <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800382:	52                   	push   %edx
  800383:	68 75 28 80 00       	push   $0x802875
  800388:	53                   	push   %ebx
  800389:	56                   	push   %esi
  ...
  80039a:	50                   	push   %eax
  80039b:	68 c0 24 80 00       	push   $0x8024c0
  8003a0:	53                   	push   %ebx
  8003a1:	56                   	push   %esi
  ...
  8003c2:	b8 b9 24 80 00       	mov    $0x8024b9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4c:	68 9f 27 80 00       	push   $0x80279f
  800b51:	6a 23                	push   $0x23
  800b53:	68 bc 27 80 00       	push   $0x8027bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd9:	68 9f 27 80 00       	push   $0x80279f
  800bde:	6a 23                	push   $0x23
  800be0:	68 bc 27 80 00       	push   $0x8027bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c1f:	68 9f 27 80 00       	push   $0x80279f
  800c24:	6a 23                	push   $0x23
  800c26:	68 bc 27 80 00       	push   $0x8027bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c65:	68 9f 27 80 00       	push   $0x80279f
  800c6a:	6a 23                	push   $0x23
  800c6c:	68 bc 27 80 00       	push   $0x8027bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cab:	68 9f 27 80 00       	push   $0x80279f
  800cb0:	6a 23                	push   $0x23
  800cb2:	68 bc 27 80 00       	push   $0x8027bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cf1:	68 9f 27 80 00       	push   $0x80279f
  800cf6:	6a 23                	push   $0x23
  800cf8:	68 bc 27 80 00       	push   $0x8027bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d37:	68 9f 27 80 00       	push   $0x80279f
  800d3c:	6a 23                	push   $0x23
  800d3e:	68 bc 27 80 00       	push   $0x8027bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800da3:	68 9f 27 80 00       	push   $0x80279f
  800da8:	6a 23                	push   $0x23
  800daa:	68 bc 27 80 00       	push   $0x8027bc
...
sys_pkt_recv(void *addr, size_t *len)
{
  ...
  800e52:	68 9f 27 80 00       	push   $0x80279f
  800e57:	6a 23                	push   $0x23
  800e59:	68 bc 27 80 00       	push   $0x8027bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f5a:	8b 04 95 48 28 80 00 	mov    0x802848(,%edx,4),%eax
  ...
  800f70:	51                   	push   %ecx
  800f71:	50                   	push   %eax
  800f72:	68 cc 27 80 00       	push   $0x8027cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8011de:	53                   	push   %ebx
  8011df:	50                   	push   %eax
  8011e0:	68 0d 28 80 00       	push   $0x80280d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8012af:	53                   	push   %ebx
  8012b0:	50                   	push   %eax
  8012b1:	68 29 28 80 00       	push   $0x802829
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80135f:	53                   	push   %ebx
  801360:	50                   	push   %eax
  801361:	68 ec 27 80 00       	push   $0x8027ec
...
0080157f <devfile_read>:
{
  ...
  8015d8:	c3                   	ret    
	assert(r <= n);
  8015d9:	68 5c 28 80 00       	push   $0x80285c
  8015de:	68 63 28 80 00       	push   $0x802863
  8015e3:	6a 7c                	push   $0x7c
  8015e5:	68 78 28 80 00       	push   $0x802878
  8015ea:	e8 76 0a 00 00       	call   802065 <_panic>
	assert(r <= PGSIZE);
  8015ef:	68 83 28 80 00       	push   $0x802883
  8015f4:	68 63 28 80 00       	push   $0x802863
  8015f9:	6a 7d                	push   $0x7d
  8015fb:	68 78 28 80 00       	push   $0x802878
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016bc:	68 8f 28 80 00       	push   $0x80288f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801ac3:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801ac4:	68 9b 28 80 00       	push   $0x80289b
  801ac9:	68 63 28 80 00       	push   $0x802863
  801ace:	6a 62                	push   $0x62
  801ad0:	68 b0 28 80 00       	push   $0x8028b0
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801b25:	c3                   	ret    
	assert(size < 1600);
  801b26:	68 bc 28 80 00       	push   $0x8028bc
  801b2b:	68 63 28 80 00       	push   $0x802863
  801b30:	6a 6d                	push   $0x6d
  801b32:	68 b0 28 80 00       	push   $0x8028b0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b86:	68 c8 28 80 00       	push   $0x8028c8
  801b8b:	53                   	push   %ebx
...
00801bea <_pipeisclosed>:
{
  ...
  801c2d:	50                   	push   %eax
  801c2e:	53                   	push   %ebx
  801c2f:	68 cf 28 80 00       	push   $0x8028cf
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802085:	56                   	push   %esi
  802086:	50                   	push   %eax
  802087:	68 f4 28 80 00       	push   $0x8028f4
  ...
  802098:	e8 65 e0 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  80209d:	c7 04 24 9c 24 80 00 	movl   $0x80249c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802170:	eb e2                	jmp    802154 <ipc_send+0x20>
			panic("sys_ipc_try_send error %d\n", r);
  802172:	50                   	push   %eax
  802173:	68 17 29 80 00       	push   $0x802917
  802178:	6a 59                	push   $0x59
  80217a:	68 32 29 80 00       	push   $0x802932
