...
sys_env_destroy(envid_t envid)
{
  ...
  800b44:	68 84 12 80 00       	push   $0x801284
  800b49:	6a 23                	push   $0x23
  800b4b:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd1:	68 84 12 80 00       	push   $0x801284
  800bd6:	6a 23                	push   $0x23
  800bd8:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c17:	68 84 12 80 00       	push   $0x801284
  800c1c:	6a 23                	push   $0x23
  800c1e:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c5d:	68 84 12 80 00       	push   $0x801284
  800c62:	6a 23                	push   $0x23
  800c64:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ca3:	68 84 12 80 00       	push   $0x801284
  800ca8:	6a 23                	push   $0x23
  800caa:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce9:	68 84 12 80 00       	push   $0x801284
  800cee:	6a 23                	push   $0x23
  800cf0:	68 a1 12 80 00       	push   $0x8012a1
...
sys_ipc_recv(void *dstva)
{
  ...
  800d55:	68 84 12 80 00       	push   $0x801284
  800d5a:	6a 23                	push   $0x23
  800d5c:	68 a1 12 80 00       	push   $0x8012a1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d86:	56                   	push   %esi
  800d87:	50                   	push   %eax
  800d88:	68 b0 12 80 00       	push   $0x8012b0
  ...
  800d99:	e8 5c f3 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800d9e:	c7 04 24 3c 10 80 00 	movl   $0x80103c,(%esp)
