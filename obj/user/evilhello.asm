...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001bc:	68 8a 24 80 00       	push   $0x80248a
  8001c1:	6a 23                	push   $0x23
  8001c3:	68 a7 24 80 00       	push   $0x8024a7
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800202:	68 8a 24 80 00       	push   $0x80248a
  800207:	6a 23                	push   $0x23
  800209:	68 a7 24 80 00       	push   $0x8024a7
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800248:	68 8a 24 80 00       	push   $0x80248a
  80024d:	6a 23                	push   $0x23
  80024f:	68 a7 24 80 00       	push   $0x8024a7
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028e:	68 8a 24 80 00       	push   $0x80248a
  800293:	6a 23                	push   $0x23
  800295:	68 a7 24 80 00       	push   $0x8024a7
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d4:	68 8a 24 80 00       	push   $0x80248a
  8002d9:	6a 23                	push   $0x23
  8002db:	68 a7 24 80 00       	push   $0x8024a7
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80031a:	68 8a 24 80 00       	push   $0x80248a
  80031f:	6a 23                	push   $0x23
  800321:	68 a7 24 80 00       	push   $0x8024a7
...
sys_ipc_recv(void *dstva)
{
  ...
  800386:	68 8a 24 80 00       	push   $0x80248a
  80038b:	6a 23                	push   $0x23
  80038d:	68 a7 24 80 00       	push   $0x8024a7
...
sys_pkt_send(void *data, size_t len)
{
  ...
  8003ef:	68 8a 24 80 00       	push   $0x80248a
  8003f4:	6a 23                	push   $0x23
  8003f6:	68 a7 24 80 00       	push   $0x8024a7
...
sys_pkt_recv(void *addr, size_t *len)
{
  ...
  800435:	68 8a 24 80 00       	push   $0x80248a
  80043a:	6a 23                	push   $0x23
  80043c:	68 a7 24 80 00       	push   $0x8024a7
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80053d:	8b 04 95 34 25 80 00 	mov    0x802534(,%edx,4),%eax
  ...
  800553:	51                   	push   %ecx
  800554:	50                   	push   %eax
  800555:	68 b8 24 80 00       	push   $0x8024b8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007c1:	53                   	push   %ebx
  8007c2:	50                   	push   %eax
  8007c3:	68 f9 24 80 00       	push   $0x8024f9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800892:	53                   	push   %ebx
  800893:	50                   	push   %eax
  800894:	68 15 25 80 00       	push   $0x802515
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800942:	53                   	push   %ebx
  800943:	50                   	push   %eax
  800944:	68 d8 24 80 00       	push   $0x8024d8
...
00800b62 <devfile_read>:
{
  ...
  800bbb:	c3                   	ret    
	assert(r <= n);
  800bbc:	68 48 25 80 00       	push   $0x802548
  800bc1:	68 4f 25 80 00       	push   $0x80254f
  800bc6:	6a 7c                	push   $0x7c
  800bc8:	68 64 25 80 00       	push   $0x802564
  800bcd:	e8 76 0a 00 00       	call   801648 <_panic>
	assert(r <= PGSIZE);
  800bd2:	68 6f 25 80 00       	push   $0x80256f
  800bd7:	68 4f 25 80 00       	push   $0x80254f
  800bdc:	6a 7d                	push   $0x7d
  800bde:	68 64 25 80 00       	push   $0x802564
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c9f:	68 7b 25 80 00       	push   $0x80257b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8010a6:	c3                   	ret    
		assert(r < 1600 && r <= len);
  8010a7:	68 87 25 80 00       	push   $0x802587
  8010ac:	68 4f 25 80 00       	push   $0x80254f
  8010b1:	6a 62                	push   $0x62
  8010b3:	68 9c 25 80 00       	push   $0x80259c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801108:	c3                   	ret    
	assert(size < 1600);
  801109:	68 a8 25 80 00       	push   $0x8025a8
  80110e:	68 4f 25 80 00       	push   $0x80254f
  801113:	6a 6d                	push   $0x6d
  801115:	68 9c 25 80 00       	push   $0x80259c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801169:	68 b4 25 80 00       	push   $0x8025b4
  80116e:	53                   	push   %ebx
...
008011cd <_pipeisclosed>:
{
  ...
  801210:	50                   	push   %eax
  801211:	53                   	push   %ebx
  801212:	68 bb 25 80 00       	push   $0x8025bb
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014c7:	68 d3 25 80 00       	push   $0x8025d3
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801668:	56                   	push   %esi
  801669:	50                   	push   %eax
  80166a:	68 e0 25 80 00       	push   $0x8025e0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8017db:	0f be 80 03 26 80 00 	movsbl 0x802603(%eax),%eax
  8017e2:	50                   	push   %eax
...
00801832 <vprintfmt>:
{
  ...
  80195a:	52                   	push   %edx
  80195b:	68 61 25 80 00       	push   $0x802561
  801960:	53                   	push   %ebx
  801961:	56                   	push   %esi
  ...
  801972:	50                   	push   %eax
  801973:	68 1b 26 80 00       	push   $0x80261b
  801978:	53                   	push   %ebx
  801979:	56                   	push   %esi
  ...
  80199a:	b8 14 26 80 00       	mov    $0x802614,%eax
